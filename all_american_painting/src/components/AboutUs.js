                ...
                <div>
                    ...
                    <div className="row about-us-cards">
                        <div className="col-lg-4">
                            ...
                            <h2>Commercial</h2>
                            <p>We service large commercial companies such as Prologis, vestibulum and vestibulum throughout the Bay Area. Explore our process and past clients for all types of commercial properties needing expert painting.</p>
                            <p>
                                <Link to="/Commercial">
